...
**文件名：AeroNodeSynchronization.h
**功能：AeroNodeSynchronization.h文件中定义了AeroNodeSynchronization类。    
*********************************************************************/
...
class QCheckBox;
/*********************************************************************
// 类  名：AeroNodeSynchronization
// 功  能：同步界面的设置
*********************************************************************/
class AeroNodeSynchronization : public QWidget
{
    Q_OBJECT
public:
    AeroNodeSynchronization(QWidget *parent = 0);
private slots:
	void clockChangeall(); 
private:
