...
//#include "rtpreceivefimclatest.cpp"
...
{  
	...
	formatComboBox->addItem(tr("300"));
	formatComboBox->setEditable(true);//可编辑
	formatComboBox->setMaxCount(3);//最多两个选项
    ...
    //设置开始摄像按钮
    //*****************************************************************	
	VideoSendButton = new QPushButton( this);//开始摄像按钮
    VideoSendButton->setText( tr( "开始摄像" ) );
    VideoSendButton ->setFixedSize(160,60);
	connect(VideoSendButton, SIGNAL(clicked()), this, SLOT(videos()));	//设置触发开始摄像
	//*****************************************************************
    //布局基本发送参数框
    //***************************************************************** 
